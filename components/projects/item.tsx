...
export default function ProjectItem({ project }: { project: Project }) {
  return (
    ...
    >
      ...
      />
      <div className="border-primary bg-background absolute bottom-0 z-10 w-full border-t-2 p-2 text-base font-semibold uppercase lg:w-96 lg:origin-bottom-left lg:rotate-[270deg] lg:truncate lg:rounded-none lg:border-none lg:bg-transparent lg:p-0 lg:text-lg">
        {project.title}
      </div>
    </Link>
  );
